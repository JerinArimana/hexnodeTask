...
const TestimonialsCard = ({
  ...
  return (
    <>
      <div className="multiTab__testimonial_item grid grid-cols-2 gap-4">
        <div
          onClick={handleShow}
          className="multiTab__testimonialVideo max-h-[440px] relative flex justify-center items-center text-center rounded-2xl overflow-hidden border-1 border-black"
        >
          <Image
            src={videoThumb}
            width={630}
        ...
        <div className="multiTab__testimonialContent rounded-2xl overflow-hidden border-1 border-black pb-8 pr-10 pt-10 pl-16 flex justify-between flex-col">
